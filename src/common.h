...
__global__ void integrate(Particle* particles, float* fx, float* fy, int num_particles, float dt, int width, int height, float max_velocity, float *target_energy, float *average_energy);
